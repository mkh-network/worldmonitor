...
We fully embrace AI-assisted development. Many of our own PRs are tagged with the LLM that helped produce them (e.g., `Co-Authored-By: Claude`), and contributors are welcome to use any AI tools they find helpful.
